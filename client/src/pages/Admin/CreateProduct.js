...
const CreateProduct = () => {
    ...
    const handleCreate = async (e) => {
        e.preventDefault();
        try {
            const productData = new FormData();//we can also wrap all inputs and select tags inside a form and add onSubmit to form wirh a function handleCreate onSubmit
