        ...
        <Layout title="Forgot-password-Ecommerce">
            <div className="form-container">
                ...
                <h4 className="title">Reset Password</h4>
                    ...
                    <div className="mb-3">
                        <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputAnswer" placeholder='Enter your Birth Place' required />
                    </div>
                    <div className="mb-3">
